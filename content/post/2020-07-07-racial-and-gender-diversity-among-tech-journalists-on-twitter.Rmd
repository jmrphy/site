...
I used the R package *rtweet* to search for anyone on Twitter who mentions one of the following tech-journalism oulets in their bio: TechCrunch, ReCode, The Information, or The Verge. The API allows for up to 1,000 results per search.
...
go13 <- search_users("beat Gigaom", n = 1000)
...
Here's the simple numerical breakdown: 106 are likely White, 20 are likely Asian, 14 are likely Black, and 8 are likely Hispanic. The rest could not be classified.
...
The roughly similar distributions across two different sampling methods suggest the sampling is probably a reasonable portrait of tech-journalism Twitter generally.
