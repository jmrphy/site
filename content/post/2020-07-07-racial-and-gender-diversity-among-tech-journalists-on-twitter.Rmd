...
The workforce of the big five tech companies is about 51% white, averaging across each company's most recent diversity report. Big Tech is therefore more diverse than tech journalism, which our analysis suggests to be between 78% and 84% white (averaging across 824 individuals who've worked for 13 popular tech-journalism outlets).
...
[Here is our dataset.](https://docs.google.com/spreadsheets/d/168IcCzJ6i3-YuEy1aQWYHwA2GqFleVfe0YVuOtMGd6o/edit?usp=sharing)
...
df %>%
  ...
  labs(x="", y="Percent White",
       ...
       subtitle = "Race inferred from Twitter bios, by subjective judgment. N=824.",
...
write.csv(df, "/Users/justin/Dropbox/Public/journos-out.csv")
...
According to the automated data-driven method, 391 are likely White, 44 Asian, 23 Black, and 23 Hispanic. The rest could not be classified. The White percentage is very close to our estimates based on subjective assessments: About 81%.
