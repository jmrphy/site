---
title: Tech Journalism is Less Diverse than Tech (Code and Data)
draft: yes
author: ''
date: '2020-07-28'
slug: tech-journalism-is-less-diverse-than-tech-code-and-data
categories:
  - theory & empirics
tags:
  - data
...
![](/img/Tech-journalism-is-less-diverse-than-tech.png)
...
The code here may be of use to others analyzing racial and/or gender diversity in other domains as well.

[Here is the final dataset with the estimated race and gender of 982 tech journalists.](https://docs.google.com/spreadsheets/d/1c4IimnX1DpPEOTI5CLhWmxuhlaocYlFD2wy1D6i-2oQ/edit?usp=sharing)
...
The initial dataset gathered by [Oo Nwoye](https://oonwoye.com/subscribe) ([\@OoTheNigerian](https://twitter.com/OoTheNigerian)) focused on the diversity of editorial staff and attendees at tech-journalism conferences, but his approach had two limitations. First, conferences are subject to a variety of selection biases, which might not have anything to do with tech-journalism culture per se. Second, there are only so many people on editorial staff or in the tech-journalism conference circuit, so this approach will likely leave us with an unnecessarily small sample.
...
Tech journalists associated with the New York Times were added before the final analysis in a somewhat *ad hoc* fashion. We first gathered names by searching for people on Twitter with "tech" and "nytimes" (the Twitter username of the NYT), and then we manually gathered the Twitter usernames of every author listed in [the Technology section](https://www.nytimes.com/section/technology) in the month of July.
...
#  It's not pretty, but it's readable for normies ;-)
# ================================================== 
...
The total number of accounts identified in this fashion was 1865, including some false positives such as generic brand entities or irrelevant coincidences. So we manually went through the results and narrowed the dataset down. We then conducted the subjective assignment of race and gender. We also standardized names and removed emojis in preparation for the next stage of analysis. This process left 982 individuals. There are a few duplicates (people who have written for multiple tech journalism outlets), which we retain for our diversity analysis at the outlet-level. We remove duplicates otherwise.

```{r analysis-sample-1, warning=F, error=F, message=F}
...
Next, let's consider gender diversity in tech journalism relative to gender diversity in the big five tech companies. Facebook reports a workforce that's 37% male. Google is 68% male. Microsoft is 72% male. Amazon is 57% male. Apple is 67% male.
...
gender.graph.df %>%
  ...
  labs(x="", y="Percent Male",
       ...
       subtitle = "Gender inferred by subjective judgment.",
...
According to this automated data-driven method, 471 are likely White, 67 Asian, 25 Black, 30 Hispanic, and 1 American Indian. (We did not code for American Indian when we did the subjective assessment.) The rest could not be classified. The White percentage is still very close to our estimates based on subjective assessments: About 77%.
...
# Export
# write.csv(df2, "tech-journalists-from-lists-df.csv")
...
I collaborated with [Oo Nwoye](https://oonwoye.com/subscribe) ([\@OoTheNigerian](https://twitter.com/OoTheNigerian)) on this analysis. This project won the $1000 Bitcoin prize that [\@balajis](https://twitter.com/balajis) had put up on Twitter for building on Oo’s work.